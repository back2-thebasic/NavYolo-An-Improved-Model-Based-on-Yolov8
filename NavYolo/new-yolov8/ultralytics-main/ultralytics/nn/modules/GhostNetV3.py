...
class GhostNetV3(nn.Module):
    def __init__(self,number):
        super(GhostNetV3, self).__init__()

        # 加载提取特征网络
        base_model = ghostnetv3(width=0.5)
...
if __name__ == '__main__':
    ...
    summary(base_model, input_size=(1, 3, 640, 640))  # 打印出模型的结构，输入通道是3，输入大小是640x640
    #print(base_model)
