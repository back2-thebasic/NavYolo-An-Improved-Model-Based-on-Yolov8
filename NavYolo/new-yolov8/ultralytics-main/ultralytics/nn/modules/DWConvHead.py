...
class DWConvHead(Detect):
    ...
    def __init__(self, nc=80, ch=()):
        ...
        self.cv3 = nn.ModuleList(nn.Sequential(Conv(x, c3, 3), AdaptiveDilatedDWConv(c3, c3, groups=math.gcd(c3, c3), kernel_size=3, stride=1, dilation=1), nn.Conv2d(c3, self.nc, 1)) for x in ch)