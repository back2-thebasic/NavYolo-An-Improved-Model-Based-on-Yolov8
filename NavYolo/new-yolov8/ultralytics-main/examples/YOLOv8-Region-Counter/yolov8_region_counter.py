...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default=r'E:\A-python\yolov8\yolov8_pt\yolov8n.pt', help='initial weights path')
    parser.add_argument('--device', default='', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--source', default=r'E:\A-python\yolov8\new-yolov8\ultralytics-main\pedestrian.mp4',type=str,  help='video file path')
